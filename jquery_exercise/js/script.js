...
let's show the user an image if the mouse over our green "GO" box.

If the user has activated the button, 
toggle the visibility of id "cat" to reveal our animated leopard.
...
var activated = false;
$("#toggle").click && $("#status").mouseover(function(){
    if (activated ==false) {
        activated = true;
        $("#cat").show("img/cat.gif");
    } else {
        activated = false;
        $("#cat").remove;
